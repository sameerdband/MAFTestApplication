...
{
    public class MyPluginContractToPluginViewAdapter : IMyPlugin
    {
        private IMyPluginContract _contract;
        private ContractHandle _handle;

        public MyPluginContractToPluginViewAdapter(IMyPluginContract contract)
        {
            _contract = contract;
        ...
        {
            _contract.Initialize(AddInSideAdapter.ViewToContractAdapter(hostObj));
        }
